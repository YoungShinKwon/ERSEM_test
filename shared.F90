module ersem_shared
   ...
   type (type_horizontal_standard_variable),parameter :: mole_fraction_of_carbon_monoxide_in_air = type_horizontal_standard_variable(name='mole_fraction_of_carbon_monoxide_in_air',units='ppb')
