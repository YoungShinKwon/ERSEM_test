...
contains
   ...
   subroutine create(self,name,model)
      ...
      select case (name)
         ...
         case ('carbon_monoxide');                         allocate(type_ersem_carbon_monoxide::model)
         ...
         !case ('bacteria_docdyn_sirem');                   allocate(type_ersem_bacteria_docdyn_sirem::model)
